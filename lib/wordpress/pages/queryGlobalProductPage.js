...
const queryGlobalProductPage = gql`
  query GET_GLOBAL_PRODUCT_PAGE($slug: String, $language: LanguageCodeEnum! = EN_US, $menuLanguage: LanguageCodeFilterEnum! = EN_US) {
    ${allMenus}
    ${headlessConfig}
...
export default queryGlobalProductPage

...
import mutationUpdateCustomerShipping from '@/lib/wordpress/user/mutationUpdateCustomerShipping'
 ...
 */
export default async function updateCustomerShipping(
  token,
  id,
  firstName,
  lastName,
  ...
  try {
    ...
    const user = await apolloClient.mutate({
      mutation: mutationUpdateCustomerShipping,
      variables,
      context: {
        headers: {
